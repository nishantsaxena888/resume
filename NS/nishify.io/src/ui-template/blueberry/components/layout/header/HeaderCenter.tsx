...
import SidebarCart from "@/ui-template/blueberry/components/cart/SidebarCart";
import MobileMenu from "@/ui-template/blueberry/components/menu/MobileMenu";
...
import { useTotalQuantity } from "@/ui-template/blueberry/store/use-cart";
import { useSession } from "@/hooks/use-session";
import { LoaderCircleIcon } from "lucide-react";
import { useAdmin } from "@/hooks/use-admin";

const HeaderCenter = ({ wishlistItem = [], main_menu, logo }: any) => {
  const { logout, session }: any = useSession();
  ...
  const totalQty = useTotalQuantity(); // reactive
  ...
  const menu = (
    <Menu
      ...
      style={{ display: "block", top: "-5px", borderRadius: "10px" }}
              ...
              <div className="inner-bottom-header">
                <div className="cols bb-logo-detail">
                  ...
                  <div className="header-logo">
                    <Link href="/">
                      <img src={logo?.light} alt="logo" className="light" />
                      <img src={logo?.dark} alt="logo" className="dark" />
                    </Link>
                  </div>
                  {/* <!-- Header Logo End --> */}
                  <Link
                ...
                <div className="cols">
                  <div className="header-search">
                    <form
                      /* onSubmit={handleSubmit} */ className="bb-btn-group-form"
                      action="#"
                    >
                      <Dropdown
                        trigger={["click"]}
                  ...
                  <div className="bb-flex-justify">
                    <div className="bb-header-buttons">
                      <div className="bb-acc-drop">
                        ...
                        >
                          ...
                          <div className="bb-btn-desc">
                            <Link
                              href={session ? "/admin/item" : ""}
                              className="bb-btn-title"
                            >
                              Account
                            </Link>
                            {session?.user ? (
                        ...
                        {/* <ul className="bb-dropdown-menu">
                          {session ? (
                            ...
                            <>
                              {login_menus.map((item: any, index: number) => (
                                <li key={index}>
                                  <Link
                                    className="dropdown-item"
                                    href={item.href}
                      ...
                      >
                        ...
                        <div className="bb-btn-desc">
                          <span className="bb-btn-title">
                            <b className="bb-cart-count">{totalQty}</b> items
                          </span>
