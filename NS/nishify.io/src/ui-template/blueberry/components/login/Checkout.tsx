...
import { useTotalPrice } from "../../store/use-cart";
...
const Checkout = () => {
  ...
  const [_registrations, setRegistrations] = useState<Registration[]>([]);
  ...
  //login
  useEffect(() => {
    const storedRegistration = JSON.parse(
  ...
  return (
    <>
      <section className="section-checkout padding-tb-30">
                ...
                <Fade triggerOnce direction="up" duration={1000} delay={800}>
                  <div className="checkout-items">
                    ...
                    <div className="payment-img">
                      <img
                        src="/assets/blueberry/img/payment/payment.png"
                        alt="payment"
                      />
                    </div>
                  </div>
                ...
                <div className="bb-checkout-contact">
                  ...
                  {textVisible && (
                    <p>
                      ...
                      up to date on an orders status, and keep track of the
                      orders you have previously made.
                    </p>
                  )}
                  {btnVisible && (
                    <div className="inner-button">
                      <a onClick={handleContinueBtn} className="bb-btn-2">
                        Continue
                      </a>
                    </div>
                  )}
                      ...
                      <div className="checkout-radio">
                        <div className="radio-itens">
                          <input
                            ...
                            checked={billingAddressMethod === "use"}
                            value="use"
                            type="radio"
                            id="address1"
                            name="address"
