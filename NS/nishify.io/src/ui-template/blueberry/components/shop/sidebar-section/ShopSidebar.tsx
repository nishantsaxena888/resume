import PriceRangeSlider from "@/ui-template/blueberry/components/price-range/PriceRangeSlider";
...
function ShopSidebar({ handlePriceChange, min, max }: any) {
        ...
        <div className="bb-sidebar-block">
          ...
          <div className="bb-sidebar-contact">
            <ul>
              ...
              <li>
                <a onClick={() => handleToggleShow("weights")}>
                  <small>{show.weights ? "less" : "load more"}</small>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div className="bb-tags">
            <ul>
              ...
              <li
                ...
                onClick={() => handleToggleShow("tags")}
              >
                <a>
                  <small>{show.tags ? "less" : "load more"}</small>
                </a>
              </li>
            </ul>
          </div>
