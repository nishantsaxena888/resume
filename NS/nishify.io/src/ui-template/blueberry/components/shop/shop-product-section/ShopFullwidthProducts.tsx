...
const ShopFullwidthProducts = ({}: // lg,
// col,
// colfive = '',
// width = '',
// itemsPerPage = 12,
    ...
    <>
      {/* <div className="bb-shop-pro-inner">
                <Row className="mb-minus-24">
                    ...
                    {!data ? (<><Spinner /></>) : (
                        <Fade triggerOnce direction='up' duration={1000} delay={200} className={`col-lg-${col} ${colfive} ${width} ${lg} col-md-4 col-6 mb-24 bb-product-box pro-bb-content ${isGridView ? "width-100" : ""}`} data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
