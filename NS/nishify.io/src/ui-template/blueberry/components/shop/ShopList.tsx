              ...
              <Row className="mb-minus-24">
                        ...
                        <div className="bb-select-inner">
                          <div>
                            <select
                              ...
                              className="custom-select custom-select-two"
                ...
                {!data ? (
                  ...
                  <Fade
                    ...
                    duration={1000}
                    delay={200}
                    // className={`col-md-${col} col-6 mb-24 bb-product-box pro-bb-content ${
