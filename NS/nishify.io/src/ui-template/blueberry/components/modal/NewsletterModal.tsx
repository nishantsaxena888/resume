  ...
  return (
    <>
      <div
        ...
        className="bb-popnews-bg"
      ></div>
      {visibleModal && (
        <div
          style={{ display: visibleModal ? "block" : "none" }}
          className="bb-popnews-box"
        >
          <div
            onClick={handleClose}
          ...
          <Row>
            <Col md={6} className="col-12">
              <img
                src={"/assets/blueberry/img/newsletter/newsletter.jpg"}
                alt="newsletter"
              />
            </Col>
            <Col md={6} className="col-12">
              <div className="bb-popnews-box-content">
                <h2>Newsletter.</h2>
                <p>
                  Subscribe the BlueBerry to get in touch and get the future
                  update.
                </p>
                <Form
                  noValidate
