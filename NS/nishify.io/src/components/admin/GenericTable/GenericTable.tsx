...
import { GTableHeader } from "./toolkit/table-header";
...
export default function GenericTable({
  ...
  } else if (hard_code_filter) {
    table_filter = {
      filters: { [hard_code_filter.key]: 0 },
    };
  }

  console.log({ entity, hard_code_filter, table_filter });
      ...
      <div className="">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-3 flex-wrap flex-1">
            <div className="relative group w-full max-w-md transition-all duration-300 ease-in-out hover:shadow-sm focus-within:shadow-md rounded-full bg-background/50">
              <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none text-muted-foreground/60 group-focus-within:text-primary transition-colors duration-300">
              ...
              <Input
                ...
                className="w-full pl-11 pr-4 py-2 bg-transparent border-muted/40 hover:border-muted focus:border-primary/50 focus-visible:ring-1 focus-visible:ring-primary/20 rounded-full h-10 shadow-none transition-colors duration-300 placeholder:text-muted-foreground/60"
              />
            </div>
          </div>
            ...
            >
              ...
              >
                <Table className="w-full caption-bottom text-sm">
                  <GTableHeader displayedCols={displayedCols} ctl={ctl} />
