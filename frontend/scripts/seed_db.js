...
const payload = {
  ...
  experience: [
    ...
    },
    {
      ...
      achievements: [
        'Project # 1 Document Extraction (https://www.simplyflow.ai) The project involves building a Document Extraction system using Python, Django, Postgresql, and OCRs like AWS Textract, Microsoft Azure, Fitz, and Tesseract OCR. The goal of the project is to automate the process of extracting relevant information from a large number of documents and save them into a structured format in a database for easy access and analysis',
        'Technologies: MSSQL, Postgresql, Django, FastAPI, Python, Azure Functions, Elastic search, Azure',
        ...
        'Standardized outputs from multiple OCR tools into a unified format for interoperability.',
        ...
        'Hosted on AWS (ECS, S3, CloudFront) with CI/CD pipelines using GitHub Actions.',
    ...
    },
    {
      ...
      achievements: [
        'Project # 1 Bumi (Contract Reader ): https://highiq.ai/Intelligent-contract-reader.php is contract analysis automation solution, processing thousands of contracts rapidly to deliver precise insights for informed decision-making.',
        'Project # 2 Oscar (Accounts payable): https://highiq.ai/Accounts-Payable-I HYPERLINK Cloud-based solution for intelligent automation of accounts payable, handling invoice monitoring, pre-processing error-free data, automatic extraction, multi-step validation workflows, and seamless ERP integration.',
    ...
    },
    {
      ...
      achievements: [
        'Project # 1 Retail Suite of tools (https://advantagesolutions.net/) Advantage Solutions merged Daymon, resulting in the most comprehensive suite of brand-centric and retailer-centric services. RSOT provides a suite of tools where systems and workforce can work together and better.',
        'Technologies: Flask, Postgresql , Elasticsearch, Angular, AWS.',
        'Project # 2 Risk Mitigation (Walmart) Enhance the legacy Django based product [SAS] , to ensure the system works well for 3 times of current load. Used load testing techniques along with log analysis using new relic and inbuilt postgrtesql query for optimization.',
        'Technologies: Python 3.6, Django, pycharm, PostgreSQL, Flask-RESTful, SQL Alchemy, pandas, py-test. Locust, New Relic.',
    ...
    },
    {
      ...
      achievements: [
        'Project # 1 DOC (RPA/AI monitoring and control platform) Pulse is a Decision Intelligence dashboard that gives you decision and operational insights that help you manage low-touch or autonomous processes in real-time.',
        'Technologies : Flask, Elasticsearch, Python, MongoDB, Neo4J, Splunk, Angular, Key-cloak, AWS SQS, SNS, Rabbitmq, UI Path.',
        'Project # 2 Enso (ML/AI platform and client specific solution) Enso is a Decision Intelligence Platform that simplifies building, orchestrating, and managing decision agents at scale.',
        'Technologies : Flask, Elasticsearch, Python, MongoDB, Splunk, Angular, Key-cloak, Apache Nifi, Django, Tornado, Kafka, Rabbitmq.',
    ...
    {
      company: 'Pramati Technologies (Client: Castlight Health)',
      location: 'Hyderabad India',
      role: 'Principal Engineer',
      duration: 'Dec 2013 – Jan 2017',
      achievements: [
        'Project # 1 Analytics and Legacy system enhancement and reporting. System had several Java Process and Microsoft Excel macros to generate reports. The legacy system has been converted to Django Portal where the complex business rules and logics are implemented in the web portal.',
        'Technologies : Python, Django, High chart, MySQL.',
        'Project # 2 In-house Test automation framework. This Framework is to facilitate the Testing team for their operations. Configurable with Bug tracking tool Jira to automate raising bugs etc.',
        'Technologies : Python, Django, Celery, selenium',
        'Project # 3 ODEX A tool to streamline daily operations for the Customer Support Team by automating repetitive tasks, identified through patterns in bug tracker requests and database queries.',
    ...
    },
    {
      ...
      achievements: [
        'Product Shine (https://www.shine.com/) Led a team of developers at Shine.com (millions of users), managing development and real-time data indexing using Python, Django, Solr, and MongoDB to ensure efficient application performance under high load.',
        'Technologies : Flask, Elasticsearch, Python, MongoDB, Splunk, Angular, Key-cloak, AWS SQS, SNS, Rabbitmq, UI Path.',
    ...
    },
    {
      ...
      achievements: [
        'Project #1 Groffr Online platform for group buying in real estate, allowing buyers to negotiate deals with builders for exclusive discounts and offers.',
        'Project #2 Verkko ConnectAlum is an alumni network platform that enables seamless onboarding for alumni and facilitates connections between alumni and college students.',
        'Technologies : Php Symfony, Python, Jquery, Mysql .',
    ...
    {
      company: 'Silverline IT Private. Ltd (Sendinblue)',
      location: 'Noida, India',
      role: 'Senior Software Engineer',
      duration: 'Jul 2008 - Dec 2009',
      achievements: [
        'Projects# Turbogear Project and Several PHP client’s projects. The client had collaboration with French partner and he used to bring several php stack projects for development.',
        'Technologies: Typo3, Php5, Apache, linux, MySql5, smarty , mootools, OpenERP, Python, linux.',
    ...
    },
    {
      ...
      achievements: [
        'https://currenex.com - Currenex is a financial technology company that provides foreign exchange (FX) trading services.',
        'Technologies : Java, Swing , Struts2, Oracle 9i , Jasper reports',
...
fetch('http://localhost:9999/api/v1/resumes', {
  ...
  body: JSON.stringify({
    title: 'Nishant Saxena - Principal Engineer Classic Complete',
    payload: payload
  })
}).then(res => res.json()).then(res => {
  console.log("SUCCESSFULLY MASTER SEEDED FULL DOCX payload TO DB:");
  console.log(res);
}).catch(console.error);
